  ...
  render() {
    return (
      <Router>
        ...
        <Container>
          <Routes>
            <Route path="/add" element={<Add onsubmit={(postid, id, text, img, likes) => this.updateListItems(postid, id, text, img, likes)} lastid={this.state.postId}/>
          }/>
            <Route exact path="/" element={<View posts={this.state.posts} likeaction={(id) => this.addLike(id)}/>
          }/>
